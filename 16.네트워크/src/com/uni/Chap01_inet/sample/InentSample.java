...
public class InentSample {
	...
	public void isSample() {
		try {
			InetAddress localIp = InetAddress.getLocalHost();//내컴퓨터의 IP주소변환
			System.out.println(("내 피씨명 : " + localIp.getHostName()));//호스트의 이름반환
			System.out.println(("내 IP : " + localIp.getHostAddress()));//호스트의 IP주소 반환
			
			
			InetAddress naverIP = InetAddress.getByName("www.naver.com");
			
			System.out.println(("네이버 서버명 : " + naverIP.getHostName()));//호스트의 이름반환
			System.out.println(("네이버서버주소 : " + naverIP.getHostAddress()));//호스트의 IP주소 반환
